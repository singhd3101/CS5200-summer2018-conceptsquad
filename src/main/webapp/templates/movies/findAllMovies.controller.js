(function () {
    ...
    function FindAllMoviesController($scope, $location, $http) {    
    	var pos;
    	var lat;
    	var long;
        function init() {
        	...
        	$http.get('https://api.internationalshowtimes.com/v4/movies/?location=42.3605,-71.0596&limit=10&fields=synopsis,trailers,id,title,poster_image_thumbnail&apikey=cMQZTx5UYw7m3Ddio8jS0NcFwgmEQkE5').
